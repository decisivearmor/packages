...
public class Messages {
  ...
  public interface AndroidVideoPlayerApi {
    ...
    void setPictureInPictureEnabled(@NonNull Long playerId, @NonNull Boolean enabled);

    @NonNull 
    Boolean isPictureInPictureSupported();

    void setNowPlayingMetadata(@NonNull Long playerId, @Nullable String title, @Nullable String artist, @Nullable String album, @Nullable String artworkUrl);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setPictureInPictureEnabled" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                try {
                  api.setPictureInPictureEnabled(playerIdArg, enabledArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setNowPlayingMetadata" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Long playerIdArg = (Long) args.get(0);
                String titleArg = (String) args.get(1);
                String artistArg = (String) args.get(2);
                String albumArg = (String) args.get(3);
                String artworkUrlArg = (String) args.get(4);
                try {
                  api.setNowPlayingMetadata(playerIdArg, titleArg, artistArg, albumArg, artworkUrlArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
