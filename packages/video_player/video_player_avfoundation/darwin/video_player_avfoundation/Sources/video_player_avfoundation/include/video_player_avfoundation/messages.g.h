...
- (void)setLoopingForPlayer:(NSInteger)playerId isLooping:(BOOL)isLooping error:(FlutterError *_Nullable *_Nonnull)error;
- (void)setVolumeForPlayer:(NSInteger)playerId volume:(double)volume error:(FlutterError *_Nullable *_Nonnull)error;
- (void)setPlaybackSpeedForPlayer:(NSInteger)playerId speed:(double)speed error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)seekToForPlayer:(NSInteger)playerId position:(NSInteger)position completion:(void (^)(FlutterError *_Nullable))completion;
...
- (void)setPictureInPictureEnabledForPlayer:(NSInteger)playerId enabled:(BOOL)enabled error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
